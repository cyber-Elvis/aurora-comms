...
| PC1 direct Ethernet | `192.168.200.1` |
| Dell direct Ethernet | `192.168.200.2` |
| GNS3 controller | `http://192.168.200.2:3080/v2` |
| GNS3 VM Tailscale | `100.118.0.46` |
| Dell Windows Tailscale | `100.109.74.61` |
| Dell E: share from GNS3 VM | `//192.168.200.2/e`, SMB username `forty3` |
