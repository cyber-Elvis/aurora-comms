...
- **Region A transit internet:** `docs/region-a-transit-internet-topology.svg` + `.png` are code-generated by `ops/region-a/diagrams/render_transit_internet_topology.py`; the PNG master and projector slides are native 4K UHD.
